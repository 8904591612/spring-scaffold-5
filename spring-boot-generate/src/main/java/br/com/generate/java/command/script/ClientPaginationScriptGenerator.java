...
public class ClientPaginationScriptGenerator  extends AbstractThymeleafGenerate {
	
	
	public ClientPaginationScriptGenerator(String nameClass, String parametersClass) throws IOException{
