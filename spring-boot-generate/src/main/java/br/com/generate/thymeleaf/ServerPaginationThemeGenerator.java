...
public class ServerPaginationThemeGenerator extends AbstractThymeleafGenerate {
	public ServerPaginationThemeGenerator(String className, String parameters) throws IOException {
	...
	public void generatedata(String className, String parameters) throws IOException{
		String htmlString = IOUtils.toString(getClass().getResourceAsStream("/templates/template-server-index.html"), null);
